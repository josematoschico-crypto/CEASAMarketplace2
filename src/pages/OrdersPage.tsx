...
import { 
  ...
  MapPin, Phone, Circle, ArrowLeft, Zap, Info 
} from 'lucide-react';
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-900">Ricardo está a caminho</p>
                </div>
              </div>
        ...
        <Card className="border-none shadow-xl bg-white rounded-[32px] overflow-hidden">
          <CardContent className="p-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-bold text-lg text-slate-900">Ricardo Silva</h4>
                <p className="text-slate-500 text-sm">Caminhão HR - ABC-1234</p>
              </div>
            </div>
            <Button 
              className="bg-green-50 text-green-600 hover:bg-green-100 rounded-2xl px-8 h-12 font-bold"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4">
                      {order.items.map((item, idx) => (
                        <div key={idx} className="flex items-center justify-between bg-slate-50/50 p-4 rounded-2xl border border-slate-50">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-500 font-medium">Vendido por: <span className="text-green-600">{item.stall}</span></p>
                            </div>
                          </div>
                          <div className="text-right">
